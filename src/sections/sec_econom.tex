...
\begin{longtable}{
    ...
    | >{\centering\arraybackslash}m{0.160\textwidth}
    | >{\centering\arraybackslash}m{0.170\textwidth}|}
...
\begin{longtable}{
    ...
    | >{\centering\arraybackslash}m{0.130\textwidth}
    | >{\centering\arraybackslash}m{0.130\textwidth}
    | >{\centering\arraybackslash}m{0.120\textwidth}
    | >{\centering\arraybackslash}m{0.120\textwidth}|}
...
\begin{longtable}{
    | >{\raggedright\arraybackslash}m{0.400\textwidth}
    | >{\centering\arraybackslash}m{0.257\textwidth}
    | >{\centering\arraybackslash}m{0.257\textwidth}|}
