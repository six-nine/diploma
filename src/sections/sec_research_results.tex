...
\begin{lstlisting}[style=CodeListing, captionpos=b, caption={Функция Measure}, label=sec_research:code:problem1_measure]
void Measure() {
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\linewidth]{\commonSecPathPrefix/sec_research_results_attachments/problem1_vanilla_timings_false_cond.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\linewidth]{\commonSecPathPrefix/sec_research_results_attachments/problem1_vanilla_timings_true_cond.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\linewidth]{\commonSecPathPrefix/sec_research_results_attachments/problem1_patched_timings_false_cond.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\linewidth]{\commonSecPathPrefix/sec_research_results_attachments/problem1_patched_timings_true_cond.png}
